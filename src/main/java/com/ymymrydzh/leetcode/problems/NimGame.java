...
/**
 * @author CC
 * @date 2016��3��18�� ����3:24:17
 * @description You are playing the following Nim Game with your friend: There
 ...
 *              Example:
 * 
 *              Input: 4 Output: false Explanation: If there are 4 stones in the
 *              heap, then you will never win the game; No matter 1, 2, or 3
 *              stones you remove, the last stone will always be removed by your
 *              friend.
 */
